  ...
  return (
    <main>
      ...
      <div className={styles.section} id="context">
        ...
        <p className={styles.sectionDesc}>Namibia has a Digital First Services for All roadmap running from 2024 to 2026 that calls for digitising its top public services. Kingdee is positioned to deliver the ERP backbone.</p>
