...
export default function Home() {
  return (
    <main>
      ...
      <div className={styles.section} id="context">
        <div className={styles.sectionLabel}>Context</div>
        <h2>Why Kingdee, and why now</h2>
        <p className={styles.sectionDesc}>Namibia’s “Digital First Services for All” roadmap (2024–2026) calls for digitising its top public services. Kingdee is positioned to deliver the ERP backbone.</p>
      ...
      <div className={styles.section} id="departments">
        ...
        <div className={styles.legend}>
          <span className={`${styles.badge} ${styles.bCoral}`}>Citizen Portal / CRM</span>
          <span className={`${styles.badge} ${styles.bPurple}`}>Finance &amp; Payments</span>
          <span className={`${styles.badge} ${styles.bTeal}`}>HR &amp; Workforce</span>
          <span className={`${styles.badge} ${styles.bAmber}`}>Procurement &amp; Assets</span>
        </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerLogo}>Kingdee<span> × </span>Namibia</div>
